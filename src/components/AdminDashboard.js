...
const AdminDashboard = () => {
  ...
  return (
    <div className="">
      {departments && (
        <NavigateTask departments={departments} onSelected={onSelected} />
      )}
      ...
      <div className="dashboard-item">
                  ...
                  <tr>
                    ...
                    <td>
                      <div
                        ...
                        onClick={(e) => onNavigate(e, value.id)}
                      >
        ...
        {active && (
          <div className="box right aquater">
            <p className="model-change" onClick={showModelPicker}>
              Change model
            </p>
            <div className="score" style={{ color: "#1ca86e" }}>
